...
'Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.122 Safari/537.36',
...
#request
    ...
    url=f'https://in.indeed.com/jobs?q=python+developer&l=chinchwad%2C+pune%2C+maharashtra&start={page}'
    url1=f'https://www.whatsmybrowser.org'
    #r=requests.get(url, headers)
    r=requests.get(url, headers={'User-Agent':random.choice(user_agents)})
    return r.status_code,r.request.headers
